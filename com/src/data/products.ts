...
export const products: Product[] = [
  ...
  // ── MEN ──
  // ترتيب: Outfit كامل الأول → Set → Trouser → Polo → Tee → Bag آخر
  {
  ...
  // ── WOMEN ──
  // ترتيب: Lounge Set الأول (أعلى rating) → Jean → Skirt → Trouser → Culotte → Top → Stripe → Short
  {
  ...
  // ── ACCESSORIES ──
  // ترتيب: اللي على جسم الأول → product shots بعدهم → من الأعلى سعراً للأقل
  {
  ...
  // ── SHOES ──
  // ترتيب: الأعلى rating أول → بعدين السعر تنازلياً
  {
  ...
  // ── SALE ──
  // ترتيب: الأعلى خصم % الأول → كلها fit: "cover" للتوحيد
  {
